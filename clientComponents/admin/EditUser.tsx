  ...
  if (error || !user) {
    return (
      <div className="flex items-center justify-center py-40 px-6">
        <div className="bg-white rounded-[40px] border border-slate-100 p-12 text-center shadow-xl shadow-slate-200/40 animate-in zoom-in-95 duration-500 max-w-md w-full">
          ...
          <p className="text-slate-400 font-bold mb-8">{error || "This user does not exist."}</p>
          <button
