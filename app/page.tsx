...
export default function LandingPage() {
  return (
    <div className="min-h-screen sm:h-screen bg-white selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden relative flex flex-col">
      ...
      {/* Header/Nav */}
      <header className="relative z-10 max-w-6xl w-full mx-auto px-4 sm:px-6 py-4 sm:py-6 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link 
            href="/auth/login" 
            className="px-3 sm:px-5 py-2 text-slate-600 text-[11px] sm:text-[13px] font-black hover:text-indigo-600 transition-all uppercase tracking-widest"
          >
            Login
          </Link>
          <Link 
            href="/auth/login" 
            className="px-4 sm:px-5 py-2 sm:py-2.5 bg-slate-900 text-white text-[11px] sm:text-[13px] font-black rounded-xl hover:bg-black transition-all shadow-lg active:scale-95 whitespace-nowrap"
          >
            Get Started
          </Link>
        </div>
